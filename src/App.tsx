    ...
    return (
      <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-stone-900/80 backdrop-blur-md">
        ...
        >
          ...
          <h3 className="text-3xl font-serif font-bold text-stone-900 mb-4">¡Último Paso!</h3>
          <p className="text-stone-600 mb-8 leading-relaxed">
            Tus respuestas están listas. Para que pueda recibirlas y empezar a trabajar en tu plan, <strong className="text-emerald-700">es imprescindible que me las envíes por WhatsApp</strong> pulsando el botón de abajo.
          </p>
          <div className="grid gap-4">
            <a 
              ...
              onClick={() => {
                // Allow closing after a short delay so they can return to the site
                setTimeout(() => {
              ...
              className="flex items-center justify-center gap-3 bg-emerald-700 text-white py-4 px-6 rounded-2xl font-bold hover:bg-emerald-800 transition-all shadow-lg shadow-emerald-700/30"
            >
              <WhatsAppIcon className="w-7 h-7 flex-shrink-0" />
              <span>Enviar Cuestionario por WhatsApp</span>
            </a>
          </div>
        </motion.div>
      </div>
